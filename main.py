...
def train_and_export(reward_target : float, realtime_render : bool, batch_size : int, env_type : Environments, method : TrainMethod, n_episodes : int):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env_type", type=str, help="Environment type", choices=["CartPole", "AcroBot", "AtariBreakout"], default="CartPole")
    parser.add_argument("--method", type=str, help="Training method", choices=["DeepQLearning", "PolicyGradient"], default="DeepQLearning")
    ...
    train_and_export(args.reward_target, args.realtime_render, args.batch_size, args.env_type, parsed_method, args.n_episodes)